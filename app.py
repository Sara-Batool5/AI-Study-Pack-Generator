...
st.info("Powered by Groq • openai/gpt-oss-120b")
...
if generate:
    ...
    try:
        ...
        st.error("The workflow stopped safely. Check your GROQ_API_KEY, model access, and Groq rate limits.")
...
st.divider()
st.caption("Built with Python • Groq • GPT-OSS 120B • Multi-stage AI workflow • Streamlit")
