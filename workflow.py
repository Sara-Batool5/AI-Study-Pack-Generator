...
def run_workflow(user_input: Dict[str, Any], on_stage: Optional[Callable] = None):
    ...
    plan = generate_json(client, PLANNER_PROMPT.format(user_input=json.dumps(user_input, ensure_ascii=False, indent=2)))
    ...
    content = generate_json(client, CONTENT_PROMPT.format(user_input=json.dumps(user_input, ensure_ascii=False, indent=2), plan=json.dumps(plan, ensure_ascii=False, indent=2)))
    ...
    assessment = generate_json(client, ASSESSMENT_PROMPT.format(user_input=json.dumps(user_input, ensure_ascii=False, indent=2), plan=json.dumps(plan, ensure_ascii=False, indent=2), content=json.dumps(content, ensure_ascii=False, indent=2)))
    ...
    review = generate_json(client, REVIEW_PROMPT.format(user_input=json.dumps(user_input, ensure_ascii=False, indent=2), plan=json.dumps(plan, ensure_ascii=False, indent=2), content=json.dumps(content, ensure_ascii=False, indent=2), assessment=json.dumps(assessment, ensure_ascii=False, indent=2)))
